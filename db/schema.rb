...
ActiveRecord::Schema.define(version: 2020_03_13_081417) do
  ...
  create_table "cran_packages_people", id: false, force: :cascade do |t|
    t.integer "cran_package_id", null: false
